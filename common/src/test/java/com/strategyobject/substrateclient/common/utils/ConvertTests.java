...
public class ConvertTests {
    ...
    void toHex() {
        ...
        for (val test : testCases) {
            assertEquals(test.expected, Convert.toHex(test.given));
        }
    }
    ...
    void toHexThrows() {
        ...
        for (val test : testCases) {
            assertThrows(test.expected, () -> Convert.toHex(test.given));
        }
    }
    ...
    void toBytes() {
        ...
        for (val test : testCases) {
            assertArrayEquals(test.expected, Convert.toBytes(test.given));
        }
    }
    ...
    void toBytesThrows() {
        ...
        for (val test : testCases) {
            assertThrows(test.expected, () -> Convert.toBytes(test.given));
        }
    }
