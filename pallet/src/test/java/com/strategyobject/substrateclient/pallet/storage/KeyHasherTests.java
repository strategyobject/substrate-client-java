...
class KeyHasherTests {
    private static Stream<Arguments> getTestCasesForGetHash() {
        return Stream.of(
                Arguments.of(
                        10,
                        TestsHelper.SCALE_READER_REGISTRY.resolve(Integer.class),
                        TestsHelper.SCALE_WRITER_REGISTRY.resolve(Integer.class),
                ...
                Arguments.of(
                        ...
                        TestsHelper.SCALE_WRITER_REGISTRY.resolve(AccountId.class),
                ...
                Arguments.of(
                        ...
                        TestsHelper.SCALE_READER_REGISTRY.resolve(BlockHash.class),
                        TestsHelper.SCALE_WRITER_REGISTRY.resolve(BlockHash.class),
    ...
    private static Stream<Arguments> getTestCasesForExtractKey() {
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        TestsHelper.SCALE_READER_REGISTRY.resolve(Void.class),
                        TestsHelper.SCALE_WRITER_REGISTRY.resolve(Void.class),
                        Identity.getInstance(),
                        null,
                        0
                ),
