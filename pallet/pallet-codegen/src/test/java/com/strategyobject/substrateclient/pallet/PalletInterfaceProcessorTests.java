...
public class PalletInterfaceProcessorTests {
    @Test
    ...
    public void compiles() {
        val generatedName = String.format("TestPalletImpl");
        ...
        assertContains(generatedName, compilation, "private final Rpc rpc;");
        ...
        assertContains(generatedName, compilation, "public TestPalletImpl(Rpc rpc)");
